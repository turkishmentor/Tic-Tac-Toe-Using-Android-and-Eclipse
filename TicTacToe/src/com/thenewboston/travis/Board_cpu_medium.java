...
public class Board_cpu_medium extends Activity{
	...
	Intent x_wi=new Intent("com.thenewboston.travis.X_WIN_CPU_MEDIUM");
	Intent o_wi_hard=new Intent("com.thenewboston.travis.O_WIN_CPU_MEDIUM");
	Intent match_ti=new Intent("com.thenewboston.travis.MATCH_TIE_CPU_MEDIUM");
	...
	public synchronized void func_medium(int ro,int co)
	{
...
board_song=MediaPlayer.create(Board_cpu_medium.this, R.raw.board_music);
