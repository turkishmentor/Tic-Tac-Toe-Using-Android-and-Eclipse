...
public class X_win extends Activity{
...
MediaPlayer background_music;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.x_win_player_vs_player);
		
		background_music=MediaPlayer.create(X_win.this, R.raw.player_win_sound);
