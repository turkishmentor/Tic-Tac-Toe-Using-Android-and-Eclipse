...
public class Board_cpu_hard extends Activity{
	...
	Intent x_wi=new Intent("com.thenewboston.travis.X_WIN_CPU_HARD");
	Intent o_wi_hard=new Intent("com.thenewboston.travis.O_WIN_CPU_HARD");
	Intent match_ti=new Intent("com.thenewboston.travis.MATCH_TIE_CPU_HARD");
	...
	public synchronized void func_hard(int ro,int co)
	{
		...
		} // draw counter==0 if end
		else
		{
			
			
			   if(O[0][0]==2 && O[0][1]==2 && Clicked[0][2]!=1)
				{
					/* O checking starts*/
					ro=0;
					co=2;
				...
				else if(O[0][0]==2 && O[0][2]==2 && Clicked[0][1]!=1)
				{
					ro=0;
					co=1;
					o_win_priority=1;
				}
				else if(O[0][1]==2 && O[0][2]==2 && Clicked[0][0]!=1)
				{
					ro=0;
					co=0;
					o_win_priority=1;
				}
				else if(O[1][0]==2 && O[1][1]==2 && Clicked[1][2]!=1)
				{
					ro=1;
					co=2;
					o_win_priority=1;
				}
				else if(O[1][1]==2 && O[1][2]==2 && Clicked[1][0]!=1)
				{
					ro=1;
					co=0;
					o_win_priority=1;
				}
				else if(O[1][0]==2 && O[1][2]==2 && Clicked[1][1]!=1)
				{
					ro=1;
					co=1;
					o_win_priority=1;
				}
				else if(O[2][0]==2 && O[2][1]==2 && Clicked[2][2]!=1)
				{
					ro=2;
					co=2;
					o_win_priority=1;
				}
				else if(O[2][0]==2 && O[2][2]==2 && Clicked[2][1]!=1)
				{
					ro=2;
					co=1;
					o_win_priority=1;
				}
				else if(O[2][1]==2 && O[2][2]==2 && Clicked[2][0]!=1)
				{
					ro=2;
					co=0;
					o_win_priority=1;
				}
				else if(O[0][0]==2 && O[1][0]==2 && Clicked[2][0]!=1)
				{
					ro=2;
					co=0;
					o_win_priority=1;
				}
				else if(O[0][0]==2 && O[2][0]==2 && Clicked[1][0]!=1)
				{
					ro=1;
					co=0;
					o_win_priority=1;
				}
				else if(O[1][0]==2 && O[2][0]==2 && Clicked[0][0]!=1)
				{
					ro=0;
					co=0;
					o_win_priority=1;
				}
				else if(O[0][1]==2 && O[1][1]==2 && Clicked[2][1]!=1)
				{
					ro=2;
					co=1;
					o_win_priority=1;
				}
				else if(O[0][1]==2 && O[2][1]==2 && Clicked[1][1]!=1)
				{
					ro=1;
					co=1;
					o_win_priority=1;
				}
				else if(O[1][1]==2 && O[2][1]==2 && Clicked[0][1]!=1)
				{
					ro=0;
					co=1;
					o_win_priority=1;
				}
				else if(O[0][2]==2 && O[2][2]==2 && Clicked[1][2]!=1)
				{
					ro=1;
					co=2;
					o_win_priority=1;
				}
				else if(O[0][2]==2 && O[1][2]==2 && Clicked[2][2]!=1)
				{
					ro=2;
					co=2;
					o_win_priority=1;
				}
				else if(O[1][2]==2 && O[2][2]==2 && Clicked[0][2]!=1)
				{
					ro=0;
					co=2;
					o_win_priority=1;
				}
				else if(O[0][0]==2 && O[2][2]==2 && Clicked[1][1]!=1)
				{
					ro=1;
					co=1;
					o_win_priority=1;
				}
				else if(O[0][0]==2 && O[1][1]==2 && Clicked[2][2]!=1)
				{
					ro=2;
					co=2;
					o_win_priority=1;
				}
				else if(O[1][1]==2 && O[2][2]==2 && Clicked[0][0]!=1)
				{
					ro=0;
					co=0;
					o_win_priority=1;
				}
				else if(O[0][2]==2 && O[2][0]==2 && Clicked[1][1]!=1)
				{
					ro=1;
					co=1;
					o_win_priority=1;
				}
				else if(O[0][2]==2 && O[1][1]==2 && Clicked[2][0]!=1)
				{
					ro=2;
					co=0;
					o_win_priority=1;
				}
				else if(O[1][1]==2 && O[2][0]==2 && Clicked[0][2]!=1)
				{
					ro=0;
					co=2;
					o_win_priority=1;
			...
			if(o_win_priority!=1)
			{
			if(X[0][0]==1 && X[0][1]==1 && Clicked[0][2]!=1)
			{
				ro=0;
				co=2;
			}
			else if(X[0][0]==1 && X[0][2]==1 && Clicked[0][1]!=1)
			{
				ro=0;
				co=1;
			}
			else if(X[0][1]==1 && X[0][2]==1 && Clicked[0][0]!=1)
			{
				ro=0;
				co=0;
			}
			else if(X[1][0]==1 && X[1][1]==1 && Clicked[1][2]!=1)
			{
				ro=1;
				co=2;
			}
			else if(X[1][1]==1 && X[1][2]==1 && Clicked[1][0]!=1)
			{
				ro=1;
				co=0;
			}
			else if(X[1][0]==1 && X[1][2]==1 && Clicked[1][1]!=1)
			{
				ro=1;
				co=1;
			}
			else if(X[2][0]==1 && X[2][1]==1 && Clicked[2][2]!=1)
			{
				ro=2;
				co=2;
			}
			else if(X[2][0]==1 && X[2][2]==1 && Clicked[2][1]!=1)
			{
				ro=2;
				co=1;
			}
			else if(X[2][1]==1 && X[2][2]==1 && Clicked[2][0]!=1)
			{
				ro=2;
				co=0;
			}
			else if(X[0][0]==1 && X[1][0]==1 && Clicked[2][0]!=1)
			{
				ro=2;
				co=0;
			}
			else if(X[0][0]==1 && X[2][0]==1 && Clicked[1][0]!=1)
			{
				ro=1;
				co=0;
			}
			else if(X[1][0]==1 && X[2][0]==1 && Clicked[0][0]!=1)
			{
				ro=0;
				co=0;
			}
			else if(X[0][1]==1 && X[1][1]==1 && Clicked[2][1]!=1)
			{
				ro=2;
				co=1;
			}
			else if(X[0][1]==1 && X[2][1]==1 && Clicked[1][1]!=1)
			{
				ro=1;
				co=1;
			}
			else if(X[1][1]==1 && X[2][1]==1 && Clicked[0][1]!=1)
			{
				ro=0;
				co=1;
			}
			else if(X[0][2]==1 && X[2][2]==1 && Clicked[1][2]!=1)
			{
				ro=1;
				co=2;
			}
			else if(X[0][2]==1 && X[1][2]==1 && Clicked[2][2]!=1)
			{
				ro=2;
				co=2;
			}
			else if(X[1][2]==1 && X[2][2]==1 && Clicked[0][2]!=1)
			{
				ro=0;
				co=2;
			}
			else if(X[0][0]==1 && X[2][2]==1 && Clicked[1][1]!=1)
			{
				ro=1;
				co=1;
			}
			else if(X[0][0]==1 && X[1][1]==1 && Clicked[2][2]!=1)
			{
				ro=2;
				co=2;
			}
			else if(X[1][1]==1 && X[2][2]==1 && Clicked[0][0]!=1)
			{
				ro=0;
				co=0;
			}
			else if(X[0][2]==1 && X[2][0]==1 && Clicked[1][1]!=1)
			{
				ro=1;
				co=1;
			}
			else if(X[0][2]==1 && X[1][1]==1 && Clicked[2][0]!=1)
			{
				ro=2;
				co=0;
			}
			else if(X[1][1]==1 && X[2][0]==1 && Clicked[0][2]!=1)
			{
				ro=0;
				co=2;
			}	
			else if(X[0][0]==1 && X[2][2]==1 && O[1][1]==2 && Clicked[1][0]!=1 && Clicked[1][2]!=1)
			{
				ro=1;
				co=0;
			}
			else if(X[0][2]==1 && X[2][0]==1 && O[1][1]==2 && Clicked[1][0]!=1 && Clicked[1][2]!=1)
			{
				ro=1;
				co=0;
			}
			else if(X[1][1]==1 && X[2][2]==1 && O[0][0]==2 && Clicked[2][0]!=1 && Clicked[0][2]!=1)
			{
				ro=2;
				co=0;
			}
			else if(X[2][0]==1 && X[1][1]==1 && O[0][2]==2 && Clicked[0][0]!=1 && Clicked[2][2]!=1)
			{
				ro=0;
				co=0;
			}
			else if(X[0][0]==1 && X[2][1]==1 && O[1][1]==2 && Clicked[2][2]!=1 && Clicked[0][2]!=1)
			{
				ro=2;
				co=2;
			}
			else if(X[0][2]==1 && X[2][1]==1 && O[1][1]==2 && Clicked[2][2]!=1 && Clicked[0][0]!=1)
			{
				ro=2;
				co=2;
			}
			else if(X[0][1]==1 && X[2][0]==1 && O[1][1]==2 && Clicked[0][0]!=1 && Clicked[1][2]!=1)
			{
				ro=0;
				co=0;
			}
			else if(X[1][2]==1 && X[2][1]==1 && O[1][1]==2 && Clicked[0][1]!=1 && Clicked[2][2]!=1)
			{
				ro=2;
				co=2;
			}
			else if(X[1][0]==1 && X[0][1]==1 && O[1][1]==2 && Clicked[0][0]!=1 && Clicked[2][2]!=1)
			{
				ro=0;
				co=0;
			}
	...
	public synchronized void set_image_and_set_clickable_false(Button b)
	{
		if(sound_for_o!=0)
	...
	public synchronized void random_producer(int r,int c)
	{
		row=rand.nextInt(3);
		col=rand.nextInt(3);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MainActivity.background_song.release();
		
board_song=MediaPlayer.create(Board_cpu_hard.this, R.raw.board_music);
		
		//background_song.start();
	if(board_song.isPlaying()==false)
	{
		board_song.start();
	}
